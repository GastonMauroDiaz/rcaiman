...
#'   different parameters should be tested or the best contrasting individual
#'   band --usually the blue one-- should be chosen instead of the output of
#'   this function.
#'
#' @examples
#' \dontrun{
...
#' blue <- caim$Blue %>% gbc()
#'
#' sky_blue_sample <- read_caim(path, c(417,311), 32, 62)
