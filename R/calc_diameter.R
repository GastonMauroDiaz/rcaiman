...
#' of Hemisfer software}. The manual suggests using a corner to set up markers
...
#'
#' If you do not have the lens projection, you should estimate it. Please see
#' \code{\link{calibrate_lens}} for more information.
#'
#'
