...
#' and the result will fit user expectations. However, if an hemispherical
#' photograph taken under the open sky is provided, this algorithm would be
#' still searching black objects against a light background, so the darker
#' portions of the sky will be taken as objects, i.e., canopy. As a consequence,
#' this will not fit users expectations, since they want the classes Gap and
#' No-gap. This kind of error could be find in photographs of open forests for
#' the same reason.
#'
