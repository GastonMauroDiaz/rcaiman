...
#'
#' This function is presented in \insertCite{Diaz2015;textual}{rcaiman}. Compute
#' the degree of membership to a color with two Gaussian membership functions
#' and the dimensions \emph{A} and \emph{B} from the \emph{CIE L*a*b*} color
#' space. The lightness dimension is not considered in the calculations.
#'
